...
\section{Experience}
  \resumeSubHeadingListStart
  \resumeSubheading
      {Senior Manager I, Data Science}{January 2022 -- Present}
      {Walmart Inc.}{Hoboken, NJ}
      \resumeItemListStart
 \resumeItem{{\bf Learning to Rank:} Leading a team of three data scientists to design advanced machine learning models in the context of learning to rank to improve the relevance and conversion of search results at Walmart.com.}
  \resumeItemListEnd
