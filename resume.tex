...
\section{Experience}
  ...
  \resumeSubheading
      ...
      {Rocket Travel, Inc.}{Burlington, NJ}
      \resumeItemListStart
 \resumeItem{{\bf Learning to Rank:} Leading a team of two data scientists designing advanced Learning to Rank models in the context of {\em hotel} ranking. Ranking models developed by the team are serving a multitude of partners by means of white-labeling.}
 \resumeItem{{\bf Translation:} Utilizing state-of-the-art neural translation models to perform real-time translation of hotel static information from English to any selected language.}
  \resumeItemListEnd
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
 \resumeItem{{\bf Learning to Rank:} Led a team of three data scientists developing various aspects of Learning to Rank pipeline, namely, feature engineering, model design/training, and model deployment. Ranking models developed by the team served $\sim 50$\% of Walmart.com traffic on both web/app platforms.}
  \resumeItemListEnd
...
\resumeItemListStart
\resumeItemInfo{(J8)}{M.Sood, A.Sridhar, \textbf{R.Eletreby}, C.W.Wu, S.A.Levin, H.V.Poor, and O.Ya\u{g}an \textit{``Spreading Processes with Mutations over Multi-layer Networks"} - submitted}

\resumeItemInfo{(J7)}{\textbf{R.Eletreby} and O.Ya\u{g}an \textit{``Secure Connectivity of Heterogeneous Wireless Sensor Networks Under a Heterogeneous On-Off Channel Model"} - submitted}


\resumeItemInfo{(J6)}{O.Ya\u{g}an, A.Sridhar, \textbf{R.Eletreby}, S.Levin, J.B.Plotkin, and H.V.Poor \textit{``Modeling and Analysis of the Spread of COVID-19 under a Multiple-strain Model with Mutations"} - Harvard Data Science Review (April 2021)}

\resumeItemInfo{(J5)}{\textbf{R.Eletreby}, Y.Zhuang, K.M.Carley, O.Ya\u{g}an, and H.V.Poor \textit{``The Effects of Evolutionary Adaptations on Spreading Processes in Complex Networks"} - Proceedings of the National Academy of Sciences (March 2020)}
...
\resumeItemListStart
\resumeItemInfo{(C14)}{A.Sridhar, O.Ya\u{g}an, \textbf{R.Eletreby}, S.Levin, J.B.Plotkin, and H.V.Poor \textit{``Leveraging A Multiple-Strain Model with Mutations in Analyzing the Spread of Covid-19"} - IEEE ICASSP 2021}
